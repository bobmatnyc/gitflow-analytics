...
class PlatformRegistry:
    ...
    def register_adapter(self, platform_name: str, adapter_class: type[BasePlatformAdapter]) -> None:
        ...
        for platform_name, adapter in self._instances.items():
            try:
                ...
                active_instances[platform_name] = {
                    ...
                    'capabilities_count': sum(1 for k, v in vars(adapter.capabilities).items() 
