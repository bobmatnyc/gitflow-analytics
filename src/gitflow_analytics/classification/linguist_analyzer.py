...
class LinguistAnalyzer:
    ...
    def __init__(self):
        ...
        self.directory_activity_patterns = {
            ...
            'ui': [
                'ui/', 'frontend/', 'client/', 'web/', 'www/', 'public/',
                'assets/', 'static/', 'components/', 'views/', 'pages/',
                'templates/', 'layouts/', 'styles/', 'css/', 'js/', 
                'javascript/', 'typescript/', 'react/', 'vue/', 'angular/'
            ],
            
            # Backend/API patterns  
            'api': [
                'api/', 'backend/', 'server/', 'service/', 'services/',
            ...
            # Database patterns
            'database': [
                'database/', 'db/', 'data/', 'models/', 'entities/',
                'repositories/', 'dao/', 'migrations/', 'schema/',
                'seeds/', 'fixtures/', 'sql/', 'queries/'
            ],
            
            # Testing patterns
            'test': [
                'test/', 'tests/', 'testing/', 'spec/', 'specs/',
                '__tests__/', 'e2e/', 'integration/', 'unit/',
            ...
            'docs': [
                ...
                'guides/', 'tutorials/', 'examples/', 'samples/',
                'wiki/', 'help/', 'manual/'
            ],
            ...
            'infrastructure': [
                ...
                'docker/', 'terraform/', 'ansible/', 'helm/',
                'ci/', 'cd/', '.github/', '.gitlab/', 'jenkins/',
                'scripts/', 'tools/', 'utilities/', 'bin/'
            ],
            
            # Configuration patterns
            'config': [
                'config/', 'configuration/', 'settings/', 'env/',
                'environment/', 'properties/', 'resources/',
                'assets/config/', 'etc/'
            ],
            ...
            'build': [
                ...
                'generated/', 'artifacts/', 'release/', 'gradle/',
                'maven/', 'npm/', 'node_modules/'
            ],
    ...
    def _analyze_single_file(self, file_path: str) -> dict[str, any]:
        ...
        is_generated = any(pattern.search(file_path) for pattern in self.compiled_generated_patterns)
    ...
    def get_language_category(self, language: str) -> str:
        ...
        """
        frontend_languages = {
            'JavaScript', 'TypeScript', 'HTML', 'CSS', 'SCSS', 'Sass', 'Less', 'Vue'
        }
        backend_languages = {
            'Python', 'Java', 'Go', 'Rust', 'Ruby', 'PHP', 'C#', 'C++', 'C', 'Scala', 'Kotlin'
        }
        mobile_languages = {
            'Swift', 'Objective-C', 'Objective-C++', 'Kotlin', 'Dart'
        }
        data_languages = {
            'SQL', 'R', 'Julia', 'Python'  # Python can be both backend and data
        }
