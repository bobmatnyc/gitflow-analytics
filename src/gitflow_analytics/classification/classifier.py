...
class CommitClassifier:
    ...
    def __init__(self, config: Optional[dict[str, Any]] = None, 
        ...
        logger.info(f"CommitClassifier initialized with {len(self.classification_categories)} categories")
    ...
    def analyze_commit_patterns(self, commits: list[dict[str, Any]]) -> dict[str, Any]:
        ...
        return {
            ...
            'high_confidence_ratio': sum(1 for c in confidence_distribution if c >= self.confidence_threshold) / total_commits,
    ...
    def export_training_data(self, commits: list[dict[str, Any]], 
        ...
        with open(output_path, 'w', newline='', encoding='utf-8') as f:
            ...
            # Write header
            writer.writerow([
                'hash', 'message', 'author', 'timestamp', 'files_changed', 
                'insertions', 'deletions', 'primary_language', 'primary_activity',
                'suggested_class', 'manual_label'
            ])
