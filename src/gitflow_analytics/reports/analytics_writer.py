    ...
    def generate_developer_focus_report(
        ...
        for dev in developer_stats:
            ...
            for project in all_projects:
                ...
                dev_pct = (
                    round(gross_commits / len(dev_commits) * 100, 1) if len(dev_commits) > 0 else 0
                )
                ...
                total_pct = (
                    round(gross_commits / total_commits * 100, 1) if total_commits > 0 else 0
                )
        ...
        for dev_id, weekly_commits in developer_weekly.items():
            ...
            if sum(weekly_values) > 0:
                ...
                row = {
                    ...
                    "min_week": min([v for v in weekly_values if v > 0])
                    if any(v > 0 for v in weekly_values)
                    else 0,
                }
