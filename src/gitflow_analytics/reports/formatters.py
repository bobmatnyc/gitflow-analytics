...
class DateFormatter:
    ...
    def format_date_range(
        start: Union[datetime, date], end: Union[datetime, date], separator: str = " to "
    ) -> str:
        """Format a date range.
    ...
    @staticmethod
    def format_week_label(week_start: Union[datetime, date], include_year: bool = True) -> str:
        """Format a week label.
...
class NumberFormatter:
    ...
    @staticmethod
    def format_decimal(
        value: Union[float, Decimal], decimal_places: int = 2, thousands_sep: str = ","
    ) -> str:
    ...
    @staticmethod
    def format_percentage(value: float, decimal_places: int = 1, include_sign: bool = True) -> str:
    ...
    @staticmethod
    def format_change(
        value: float, decimal_places: int = 1, include_sign: bool = True, positive_prefix: str = "+"
    ) -> str:
...
class JSONFormatter:
    ...
    @staticmethod
    def format_json(
        data: Any, indent: int = 2, sort_keys: bool = False, ensure_ascii: bool = False
    ) -> str:
        """Format data as JSON.
...
class MetricFormatter:
    ...
    @staticmethod
    def format_line_changes(additions: int, deletions: int, net: bool = False) -> str:
    ...
    @staticmethod
    def format_velocity(value: float, unit: str = "commits/week") -> str:
    ...
    @staticmethod
    def format_score(score: float, max_score: float = 100, include_grade: bool = True) -> str:
