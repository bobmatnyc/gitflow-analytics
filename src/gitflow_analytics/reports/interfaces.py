...
class ReportSchema:
    ...
    def validate(self, data: dict[str, Any]) -> bool:
        ...
        for field in self.fields:
            ...
            if field.name in data and not field.validate(data[field.name]):
                return False
...
class IReportFactory(ABC):
    ...
    def create_generator(
        self, report_type: ReportType, format_type: ReportFormat, **kwargs
    ) -> ReportGenerator:
    ...
    def register_generator(
        self, report_type: ReportType, format_type: ReportFormat, generator_class: type
    ) -> None:
...
class IReportExporter(ABC):
    ...
    @abstractmethod
    def export(
        self, report_data: Any, format_type: ReportFormat, output_path: Optional[Any] = None
    ) -> Any:
